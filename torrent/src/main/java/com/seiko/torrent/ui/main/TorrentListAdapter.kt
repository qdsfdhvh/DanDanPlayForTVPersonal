...
class TorrentListAdapter(
    ...
    inner class ItemViewHolder(view: View) : RecyclerView.ViewHolder(view),
        ...
        private val itemTorrentList: ConstraintLayout = view.findViewById(R.id.item_torrent_list)
        ...
        private fun bind(item: TorrentListItem, position: Int) {
            ...
            if (currentHash != null && currentHash == item.hash) {
