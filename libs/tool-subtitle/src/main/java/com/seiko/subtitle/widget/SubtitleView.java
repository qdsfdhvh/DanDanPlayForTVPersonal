...
public class SubtitleView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = mBottomSubtitles.length - 1; i >= 0; i--) {
            ...
            int y = mSubtitleY - mTextBounds.height() / 2 - 50;
    ...
    public void setTopAndBottomTexts(SubtitleText[] topSubtitleArray, SubtitleText[] bottomSubtitleArray) {
        this.mTopSubtitles = topSubtitleArray;
        this.mBottomSubtitles = bottomSubtitleArray;
        invalidate();
    }
